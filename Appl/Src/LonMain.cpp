...
RestartData_st __attribute__(( section(".noinit") )) restartData;
...
void HardFault_Handler(void)
{
  ...
  register uint32_t __regPC          __ASM("lr");
  restartData.PCreg = __regPC ;
  register uint32_t __regSP          __ASM("sp");
  restartData.SPreg = __regSP;
  register uint32_t __regLR          __ASM("lr");
  restartData.LRreg = __regLR;

  register uint32_t __regR0          __ASM("r0");
  restartData.rReg[0]= __regR0;
    register uint32_t __regR1          __ASM("r1");
  restartData.rReg[1]= __regR1;
    register uint32_t __regR2          __ASM("r2");
  restartData.rReg[2]= __regR2;
    register uint32_t __regR3          __ASM("r3");
  restartData.rReg[3]= __regR3;
    register uint32_t __regR4          __ASM("r4");
  restartData.rReg[4]= __regR4;
    register uint32_t __regR5          __ASM("r5");
  restartData.rReg[5]= __regR5;
    register uint32_t __regR6          __ASM("r6");
  restartData.rReg[6]= __regR6;
    register uint32_t __regR7          __ASM("r7");
  restartData.rReg[7]= __regR7;


  restartData.CFSRreg = *((uint32_t*)0xE000ED28);
  restartData.HFSRreg = *((uint32_t*)0xE000ED2C);
  restartData.MMFARreg = *((uint32_t*)0xE000ED34);
  restartData.BFAR = *((uint32_t*)0xE000ED38);
