...
#define CONF_USE_SDCARD 1
#define CONF_USE_RNG 1
#define CONF_USE_BOOTUNIT 0


#define CONF_USE_UART_TERMINAL 1
...
#define LON_USE_SENSORS 1
#define LON_USE_HTTP_INTERFACE 1
#define LON_USE_TIMERS 1
#define LON_USE_COMMAND_LINK 1
#define LON_USE_PWR_MGMT 1
#define LON_USE_SENSORS_DATABASE 1
#define LON_USE_IRRIGATION_UNIT 1
#define LON_USE_WEATHER_UNIT 1
